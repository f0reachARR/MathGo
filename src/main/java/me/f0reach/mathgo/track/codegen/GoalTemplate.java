...
public final class GoalTemplate implements SegmentTemplate {
    ...
    public PlacedSegment place(Location entry, Direction forward) {
        TunnelBuilder.carveStraight(entry, forward, LENGTH, WIDTH, Material.GOLD_BLOCK, Material.EMERALD_BLOCK,
                Material.RAIL);
        ...
        if (world != null) {
            ...
            TunnelBuilder.setBlock(world, ex, by + 1, ez, Material.SEA_LANTERN.createBlockData());
        }
